<aside id="sidebarNavDraw" class="flex fixed top-0 left-0 z-40 w-auto h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
    <div class="h-full px-3 pb-4 overflow-y-auto dark:bg-gray-800 pt-20 bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
        <ul class="space-y-2 font-medium" >
            <li>
                <a href="{{route('dashboard')}}" wire:navigate class="@if(Request::segment(1) === 'dashboard') bg-primary-soft dark:bg-gray-750 @endif flex items-center p-2 text-sm text-gray-500 dark:text-gray-300 rounded-lg hover:text-primary dark:hover:text-primary hover:bg-primary-soft dark:hover:bg-gray-750"
            ...
            <li>
                <a href="{{route('users.render')}}" wire:navigate class="@if(Request::is('users')) bg-primary-soft dark:bg-gray-750 @endif flex items-center p-2 text-sm text-gray-500 dark:text-gray-300 rounded-lg hover:text-primary dark:hover:text-primary hover:bg-primary-soft dark:hover:bg-gray-750"
